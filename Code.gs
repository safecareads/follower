...
function doPost(e) {
  try {
    ...
    // LockService prevents two near-simultaneous submissions from creating duplicates.
...
function handleVerifyPaymentRequest_(e) {
  ...
  // GET verification sends fields directly; POST verification may send JSON payload.
  if (e && e.parameter) {
    if (e.parameter.amount !== undefined) payload.amount = e.parameter.amount;
    if (e.parameter.paymentSenderNumber !== undefined) payload.paymentSenderNumber = e.parameter.paymentSenderNumber;
    if (e.parameter.transactionId !== undefined) payload.transactionId = e.parameter.transactionId;
    if (e.parameter.paymentMethod !== undefined) payload.paymentMethod = e.parameter.paymentMethod;
  }
